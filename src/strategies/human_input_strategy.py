...
class HumanInputStrategy(BaseStrategy):
    ...
    def choose_card_to_play(self, game_state: Dict[str, Any]) -> Card:
        ...
        message = (
            ...
            "5: Show total points per player"
        )
        while not valid_input:
            ...
            if user_input == "1":
                ...
                self.show_total_points_per_player(game_state)
                continue
            if back_to_start:
                back_to_start = False
                print(message)
        ...
        raise RuntimeError(
            "Exited loop without returning, in function "
    ...
    def choose_pile_to_replace(self, game_state: Dict[str, Any]) -> int:
        ...
        while not valid_input:
            ...
            if user_input == "1":
                ...
                self.show_per_pile_cards(game_state)
                print(
                    "Enter the pile number to replace (1-4) or 5 to return "
